...
class GaussianDiffusion:
    ...
    def _predict_xstart_from_xprev(self, x_t, t, xprev):
        print('==============================_predict_xstart_from_xprev===================================')
    ...
    def _predict_eps_from_xstart(self, x_t, t, pred_xstart):
        print('==============================_predict_eps_from_xstart===================================')
        return (_extract_into_tensor(self.sqrt_recip_alphas_cumprod, t,
                                     x_t.shape) * x_t -
    ...
    def _predict_start_from_z_and_v(self, x_t, t, v):
        print('==============================_predict_start_from_z_and_v==================================')
    ...
    def _predict_eps_from_z_and_v(self, x_t, t, v):
        print('==============================_predict_eps_from_z_and_v==================================')
        return (
    ...
    def p_sample(
        ...
        print('xixixixixixixixixixixixixixixixixixixixixixixi')
        return {"sample": sample, "pred_xstart": out["pred_xstart"]}

    def get_mixing_component(self, x_noisy, t, enabled):
        print('===========================get_mixing_component==============================')
    ...
    def p_sample_mixing_component(
        ...
        print('===========================p_sample_mixing_compoent==============================')
        """
        Sample x_{t-1} from the model at the given timestep.
