...
def training_loop(args):
    ...
    for param in auto_encoder.decoder.triplane_decoder.parameters(): # type: ignore
    ...
    TrainLoop = {
        ...
        'ssd_cvd_sds_no_separate_sds_step': nsr.TrainLoop3DDiffusionSingleStagecvDSDS_sdswithrec,
    }[args.trainer_name]
