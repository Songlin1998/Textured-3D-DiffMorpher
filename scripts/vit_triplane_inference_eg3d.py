...
from nsr.script_util import create_3DAE_model, encoder_and_nsr_defaults, loss_defaults, eg3d_options_default
...
def training_loop(args):
    ...
    # th.save(resume_data, Path(args.resume_checkpoint_EG3D).parent / 'afhq.ckpt')
    resume_data = th.load(args.resume_checkpoint_EG3D,
    ...
    TrainLoop(G=G_ema,
              ...
              eval_data=eval_data,
              **vars(args)).eval_loop()  # ! overfitting
    ...
    #           data=training_set_iterator,
    #           eval_data=eval_data,
    #           **vars(args)).eval_novelview_loop()  # ! overfitting
    ...
    #           data=training_set_iterator,
    #           eval_data=eval_data,
    #           **vars(args)).eval_novelview_loop_eg3d()  # ! overfitting
