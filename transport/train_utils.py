...
def parse_transport_args(parser):
    ...
    # group.add_argument("--snr-type", type=str, default="uniform", choices=["uniform", "lognorm", "lognorm-mv", "lognorm-mv-plucker", "lognorm-highres"])
    group.add_argument("--snr-type", type=str, default="uniform")
